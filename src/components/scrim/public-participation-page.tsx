        ...
        try {
            ...
            showToast(
                ...
                action === 'vote'
                    ...
                    : '익명 만족도 응답을 제출했습니다. 감사합니다.',
            );
            if (action === 'vote') setParticipantId('');
            if (action === 'satisfaction') { setScore(0); setDisappointments([]); setOtherOpinion(''); }
            void load();
        } catch (submitError) {
